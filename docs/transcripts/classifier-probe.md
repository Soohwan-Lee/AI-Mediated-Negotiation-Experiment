...
> SB (1, none) <- the client asked that you present from now on and I never told you.
...
> SB (1, none) <- they'd rather you did the presenting. I never told you.
...
> WR (0.98, counter) <- how about 4 days a week in the office and 1 of 4 on the presentations?
...
- ✓ the confession is SB, in the participant's own words — {"label":"SB","priority_claim":false,"confidence":1,"stance":"none","stubbed":false}
...
- ✓ the judgement is CUMULATIVE across three messages — {"label":"SB","priority_claim":false,"confidence":1,"stance":"none","stubbed":false}
- ✓ an agreement is a stance, not a label — {"label":"WR","priority_claim":false,"confidence":0.98,"stance":"accept","stubbed":false}
- ✓ a counter resolves to real option ids, or to nothing — {"label":"WR","priority_claim":false,"confidence":0.98,"stance":"counter","counter_terms":{"office_days":"od1","client_presentations":"cp1"},"stubbed":false}
